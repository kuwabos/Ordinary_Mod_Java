...
import net.isaya.items.WobItem;
...
public class Registration {
    ...
    public static final RegistryObject<Item> LOSItem = ITEMS.register("longstickitem", () -> new RidiculouslyLongStickItem(new Item.Properties()));

    public static final RegistryObject<Item> WOBItem = ITEMS.register("wobitem", () -> new WobItem(new Item.Properties().tab(CreativeModeTab.TAB_TOOLS)));
}
